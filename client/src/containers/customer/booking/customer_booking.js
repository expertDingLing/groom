        ...
        return (
            <div className={classes.container}>
                <Grid className={classes.content}>
                    {formState === 'second' && (
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                <img src={'/assets/images/recent_book1.png'} alt='' onClick={() => this.setState({ formState: "final" })} className={classes.image1} />
                    ...
                    {formState === 'final' && (
                        <div>
                            <Typography className={classes.header}>Booking</Typography>
                            <div style={{ position: 'relative' }}>
                                <img src={'/assets/images/recent_book1.png'} alt='' onClick={() => this.setState({ formState: "final" })} className={classes.image1} />
                                <Typography className={classes.title1}>When was the last time you spent on your well being?</Typography>
                                <Typography className={classes.title2}>Explore our services now and unwind?</Typography>
                            </div>
                            <button className={classes.explore}>Explore Groom</button>
                            <Typography className={classes.title}>What you have booked</Typography>
                            <div>
                                        ...
                                        <Grid container spacing={1}>
                                            <Grid item xs={12}>
                                                ...
                                                <div style={{ display: "flex" }}>
                                                    <ListItem button>
                                                        <ListItemText primary="Confirmed" className={classes.confirmed} />
                                                    </ListItem>
                                                    <ListItem button>
                                                ...
                                                <div style={{ display: "flex" }}>
                                                    <ListItem button>
                                                        <ListItemText primary="Booking requested" />
                                                    </ListItem>
                                                    <ListItem button>
                                                        <ListItemText primary="1:00 PM" />
                                                    </ListItem>
                            ...
                            <Grid item lg={5}>
                                <div className={classes.first}>
                                    ...
                                    <div className={classes.show}>
                                        ...
                                        <ArrowForwardIosIcon className={classes.forward} onClick={() => this.setState({ formState: "second" })} />
                                    </div>
                                    <Divider className={classes.divider} />
